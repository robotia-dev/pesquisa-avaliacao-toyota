  ...
  if (params.caixa) {
    ...
    return (
      <div className='h-screen w-full content-center'>
        <div class="border border-blue-300 shadow shadow-xl rounded-md p-4 max-w-sm w-full mx-auto text-center">
          <div className='flex flex-col items-center'>
            <Image className='' src='/nissey-logo.png' width={150} height={150} />
